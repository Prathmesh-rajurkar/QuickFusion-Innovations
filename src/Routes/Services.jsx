...
function Services() {
    return (
        <div className="bg-slate-950">
            <div className="h-full min-h-screen w-full bg-slate-950 pt-24 p-4 flex flex-col gap-20 justify-center items-center mb-24">
                ...
                <div className="flex flex-wrap gap-20 w-full justify-around mx-5">
                    <motion.div className="rounded-xl bg-white p-6 text-center shadow-xl w-96 h-80 cursor-pointer hover:bg-teal-200"
                    ...
                    >
                        ...
                        <h1 className="text-darken mb-3 text-xl font-medium lg:px-14">Website Development</h1>
                    ...
                    <motion.div className="rounded-xl bg-white p-6 text-center shadow-xl w-96 h-80 cursor-pointer hover:bg-rose-200"
                        whileInView={{ opacity: 1, y: 0 }}
                        initial={{ opacity: 0, y: -100 }}
                        transition={{ duration: 1 }}
                    >
                        ...
                        <h1 className="text-darken mb-3 text-xl font-medium lg:px-14">App Development</h1>
                    ...
                    <motion.div className="rounded-xl bg-white p-6 text-center shadow-xl w-96 h-80 cursor-pointer hover:bg-sky-200"
                        whileInView={{ opacity: 1, x: 0 }}
                        initial={{ opacity: 0, x: 100 }}
                        transition={{ duration: 1 }}
                    >
                        ...
                        <h1 className="text-darken mb-3 text-xl font-medium lg:px-14">Tech & IT Solutions</h1>
                ...
                <div className="flex flex-wrap gap-20 w-full justify-around mx-5">
                    ...
                    >
                        ...
                        <h1 className="text-darken mb-3 text-xl font-medium lg:px-14">Digital Marketing</h1>
                    ...
                    >
                        ...
                        <h1 className="text-darken mb-3 text-xl font-medium lg:px-14">Graphic Designing</h1>
                    ...
                    >
                        ...
                        <h1 className="text-darken mb-3 text-xl font-medium lg:px-14">Social Media Marketing</h1>
